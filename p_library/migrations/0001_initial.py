    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='entries', to='p_library.author', verbose_name='Автор')),
                ('publisher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='entries', to='p_library.publisher', verbose_name='Издательство')),
            ],
            options={
                'verbose_name': 'книга',
